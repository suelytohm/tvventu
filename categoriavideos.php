...
$rs = $connection->prepare("SELECT id, titulo, imagem_principal as imagem, date_format(data, '%d/%m/%Y') data, upper(categoria) categoria FROM postagens WHERE categoria = 'melhoresDoAno' and visivel = 'S' order by(id) desc limit 50;");
